...
public class BaseHelper {
     ...
     * @return
     */
    public int dml(Function<SqlSession,Integer> sessionFunction){
    ...
    public <T> T query(Function<SqlSession, T> sessionTFunction) {
        try(SqlSession session = SqlSessionHelper.openSession()){
