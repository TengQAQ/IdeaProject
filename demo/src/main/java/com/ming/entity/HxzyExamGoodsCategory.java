...
/**
 * 
 * @TableName hxzy_exam_goods_category
 */
public class HxzyExamGoodsCategory implements Serializable {
    /**
     * 分类id
     */
    ...
    private List<HxzyExamGoodsCategory> children;
    ...
    public List<HxzyExamGoodsCategory> getChildren() {
        return children;
    }

    public void setChildren(List<HxzyExamGoodsCategory> children) {
    ...
    public boolean equals(Object that) {
        ...
        HxzyExamGoodsCategory other = (HxzyExamGoodsCategory) that;
